RSpec.describe 'GET /api/articles/:id' do
  describe 'succesfully' do
    let!(:article) { create(:article, title: 'This is the latest news', body: 'And this is some great content') }
    ...
    it 'is expected to return the requested articles body' do
      expect(response_json['article']['body']).to eq 'And this is some great content'
    end
  end
end